...
namespace EBRICENTER
{
    ...
    {
        public int giIdEmpleado { get; set; }
        ...
        public csEmpleado(int pIdemp, string pnombre1, string pnombre2, string papellido1, string papellido2, string pfechaalta, string pfechabaja,int pSalario, int piddepto, int pidjornada, string pDomicilioEmp, string pTelefonoEmp, string pMovilEmp, string pEmailEmp)
        {
