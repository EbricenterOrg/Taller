...
namespace EBRICENTER
{
    public partial class wfClientes : Form
    {
        ...
        private void btnGuardarCte_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                pCliente.iTelefono_cte = Convert.ToInt32(txtTelCte.Text);
                pCliente.iMovil_cte = Convert.ToInt32(txtMovilCte.Text);
       ...
       private void btnBusCliente_Click(object sender, EventArgs e)
       {
        ...
        //     int  x1 = buscar.ClienteSeleccionado.iId_cte;
    ...
    /*         Convert.ToInt32(txtTelCte.Text) = buscar.ClienteSeleccionado.iTelefono_cte;
               Convert.ToInt32(txtMovilCte.Text)= buscar.ClienteSeleccionado.iMovil_cte ;
    */         txtEmailCte.Text = buscar.ClienteSeleccionado.sEmail_cte;
               

               btnGuardarCte.Enabled = true;
               btnEliminaCte.Enabled = true;
            //   int x2 = Convert.ToInt32(txtIdCte.Text);
